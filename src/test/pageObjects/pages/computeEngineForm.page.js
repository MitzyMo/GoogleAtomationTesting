class ComputeEngineFormPage {
  ...
  get estimatedCostElement() {return $('//label[@class="gt0C8e MyvX5d D0aEmf"]');}
  ...
  get totalEstimatedCostElement() {return $('//label[@class="gN5n4 MyvX5d D0aEmf"]');}
  ...
  async getTotalEstimatedCostText() {
    ...
    return await this.totalEstimatedCostElement.getText();
  }
